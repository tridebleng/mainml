...
run_ei() {
  ...
  # Link izin IP VPS
  url_izin='https://raw.githubusercontent.com/tridebleng/permission/main/izin.txt'
...
wget https://raw.githubusercontent.com/tridebleng/mainml/main/menu.zip
unzip menu.zip
chmod +x *
rm -fr menu.zip
#######service
...
wget -O /etc/nginx/conf.d/funnvpn.conf https://raw.githubusercontent.com/Rerechan02/mlbb/main/funnvpn.conf
...
wget -O /etc/xray/config.json https://raw.githubusercontent.com/Rerechan02/mlbb/main/config.json
